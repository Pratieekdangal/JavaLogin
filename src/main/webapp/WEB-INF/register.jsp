                        ...
                        <div class="form-group">
                            ...
                            <div class="role-options">
                                <label class="role-card ${param.type == 'jobseeker' ? 'selected' : ''}">
                                    <input type="radio" name="role" value="jobseeker" ${param.type=='jobseeker'
                                        ? 'checked' : '' }>
                                ...
                                <label class="role-card ${param.type == 'employer' ? 'selected' : ''}">
                                    <input type="radio" name="role" value="recruiter" ${param.type=='employer'
                                        ? 'checked' : '' }>
                                    <div class="role-content">
                                        <div class="role-icon">🏢</div>
                                        <div class="role-info">
