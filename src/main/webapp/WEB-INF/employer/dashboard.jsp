                ...
                <body class="dashboard-page">
                    <nav class="navbar">
                        <div class="nav-container">
                            ...
                            <ul class="nav-menu">
                                <li><a class="nav-link" href="${pageContext.request.contextPath}/post-job">Post a
                                        Job</a></li>
                                <li><a class="nav-link active"
                                        href="${pageContext.request.contextPath}/employer/dashboard">Dashboard</a></li>
                    ...
                    <div class="dashboard-container">
                        <div class="company-profile-section">
                            <div class="company-header">
                                ...
                                <div class="company-actions">
                                    <a href="${pageContext.request.contextPath}/edit-company"
                        ...
                        <div class="jobs-section">
                            <div class="section-header">
                                ...
                                <a href="${pageContext.request.contextPath}/post-job" class="button button-primary">Post
                                    New Job</a>
                            </div>
                            ...
                            <c:if test="${empty postedJobs}">
                                <div class="empty-state">
                                    ...
                                    <a href="${pageContext.request.contextPath}/post-job"
                                        class="button button-primary">Post Your First Job</a>
                                </div>
                            </c:if>
                                    ...
                                    <c:forEach var="job" items="${postedJobs}">
                                        <div class="job-card">
                                            <div class="job-card-header">
                                                ...
                                                <span
                                                    class="job-status ${job.status == 'ACTIVE' ? 'status-active' : 'status-inactive'}">
                                                    ${job.status}
                                                </span>
                                            </div>
                                            ...
                                            <div class="job-actions">
                                                ...
                                                <a href="${pageContext.request.contextPath}/employer/jobs/edit?id=${job.id}"
                                                ...
                                                <c:forEach var="application" items="${applicationsByJob[job.id]}">
                                                    <div class="application-card">
                                                        <div class="application-header">
                                                            <span class="application-title">Application from
                                                                ${application.applicantName}</span>
                                                            <span
                                                                class="application-status status-${fn:toLowerCase(application.status)}">${application.status}</span>
                                                        </div>
                                                        <div class="application-meta">
                                                            <p>📅 Applied:
                                                                <fmt:formatDate value="${application.appliedDate}"
                                                                    pattern="MMM dd, yyyy" />
                                                            </p>
                                                            <p>📧 Email: ${application.applicantEmail}</p>
                                                            <p>📎 Resume: <a href="${application.resumePath}"
                    ...
                    <script>
                        ...
                        function deleteJob(jobId) {
                            if (confirm('Are you sure you want to delete this job posting?')) {
                                fetch('${pageContext.request.contextPath}/employer/jobs/delete', {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/x-www-form-urlencoded'
                                    },
